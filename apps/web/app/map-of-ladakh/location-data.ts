// Central location data — used as static seed & fallback when API is unavailable
...
> = {
  city:      { label: "City",       emoji: "🏘️", color: "bg-amber-500/20 text-amber-300 border-amber-500/30" },
  lake:      { label: "Lake",       emoji: "🌊", color: "bg-blue-500/20 text-blue-300 border-blue-500/30" },
  pass:      { label: "Pass",       emoji: "⛰️", color: "bg-slate-500/20 text-slate-300 border-slate-500/30" },
  monastery: { label: "Monastery",  emoji: "🛕", color: "bg-orange-500/20 text-orange-300 border-orange-500/30" },
  valley:    { label: "Valley",     emoji: "🏔️", color: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30" },
  school:    { label: "School",     emoji: "🏫", color: "bg-purple-500/20 text-purple-300 border-purple-500/30" },
  town:      { label: "Town",       emoji: "🏘️", color: "bg-rose-500/20 text-rose-300 border-rose-500/30" },
  permit:    { label: "Permit",     emoji: "📄", color: "bg-zinc-500/20 text-zinc-300 border-zinc-500/30" },
};
...
export const STATIC_LOCATIONS: Location[] = [
  {
    ...
    shortDescription: "The high-altitude capital of Ladakh, gateway to all adventures with ancient palaces and vibrant bazaars.",
  ...
  },
  {
    ...
    shortDescription: "Historic town on the NH-1 road, famous for the 1999 Kargil War and its unique blend of Shia and Buddhist cultures.",
  ...
  },
  {
    ...
    shortDescription: "A stunning, ever-changing blue lake straddling the India–China border, stretching 134 km across the Himalayan plateau.",
  ...
  },
  {
    ...
    shortDescription: "A lush river valley between the Karakoram and Ladakh ranges, famous for Bactrian camels and towering sand dunes.",
  ...
  },
  {
    ...
    shortDescription: "A pristine high-altitude lake in the Changthang plateau, a Ramsar wetland and breeding ground for rare bar-headed geese.",
  ...
  },
  {
    ...
    shortDescription: "Remote Changthang village hosting one of the world's highest astronomical observatories, with India's darkest skies.",
  ...
  },
  {
    ...
    shortDescription: "One of the world's highest motorable passes, gateway to the Nubra Valley with breathtaking 360° mountain views.",
  ...
  },
  {
    ...
    shortDescription: "The third-highest motorable pass in the world, the primary route connecting Leh to Pangong Lake.",
  ...
  },
  {
    ...
    shortDescription: "Ladakh's oldest monastery perched on an eroded moonland landscape, offering one of the most surreal views in the Himalayas.",
  ...
  },
  {
    ...
    shortDescription: "A gravity-defying optical illusion on the Leh–Kargil highway where vehicles appear to roll uphill on their own.",
  ...
  },
  {
    ...
    altitude: "3,050 m",
    distanceFromLeh: "150 km",
    shortDescription: "The oldest and largest monastery in Nubra Valley, crowned by a 32-metre Maitreya Buddha statue watching over the valley.",
  ...
  },
  {
    ...
    shortDescription: "A thousand-year-old monastic complex with some of the finest Kashmir-style Buddhist art in the entire Himalayas.",
  ...
  },
  {
    ...
    shortDescription: "A magnificent 12-storey monastery complex resembling the Potala Palace in Lhasa, housing a 15-metre Maitreya Buddha statue.",
  ...
  },
  {
    ...
    shortDescription: "An award-winning sustainable school inspired by Shang-ri-La, designed by Arup Associates and opened in 2001 near Shey.",
  ...
  },
  {
    ...
    shortDescription: "One of India's most remote and spectacular valleys, accessible only in summer by road or in winter via the legendary Chadar frozen river trek.",
    longDescription: "Zanskar is a remote sub-district of Kargil district, largely cut off from the outside world by snow for 7–8 months of the year. The valley is encircled by some of the highest peaks of the Himalayas and Zanskar Range, and is accessed via the Pensi La pass (4,401 m) from Kargil during summer, or by the extraordinary Chadar Trek — a frozen Zanskar River walk — in January-February. The valley has its own royal lineage, ancient monasteries (Karsha, Phugtal, Zangla), and a distinct culture. The Zanskar River, a major tributary of the Indus, provides one of the most thrilling whitewater rafting routes in Asia. The dramatic gorge it cuts through the mountains on its way to join the Indus is one of Ladakh's most surreal landscapes.",
    images: [
  ...
  },
  {
    ...
    shortDescription: "A scenic green valley winding from Kargil towards Zanskar, framed by glaciers and the twin peaks of Nun and Kun.",
