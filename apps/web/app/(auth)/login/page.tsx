    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm">Log in or sign up to continue</p>
        </div>
        ...
        {!isEmailView ? (
          <div className="space-y-4">
            <Button 
              variant="outline" 
              className="w-full h-12 bg-white text-black hover:bg-zinc-200 border-0 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-3"
            ...
            <Button 
              variant="outline" 
              className="w-full h-12 bg-zinc-800/50 text-white hover:bg-zinc-800 border border-white/5 rounded-xl font-medium transition-all duration-300"
            ...
            {emailSent ? (
              <div className="text-center space-y-4 py-4">
                ...
                <p className="text-zinc-400 text-sm leading-relaxed">
                  We've sent a magic link to <span className="text-white font-medium">{email}</span>. Click the link to sign in instantly.
                </p>
                <Button 
                  variant="ghost" 
              ...
              <form onSubmit={handleEmailSignIn} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 bg-amber-500 text-black hover:bg-amber-600 rounded-xl font-medium transition-all duration-300"
